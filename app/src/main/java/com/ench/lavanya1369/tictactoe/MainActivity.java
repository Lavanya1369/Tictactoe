...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.btncancel);
        ...
        text=(TextView)findViewById(R.id.tp1);
        textView2=(TextView) findViewById(R.id.tp2);
        Intent intent = getIntent();
        String id1 = intent.getStringExtra("TextBox");
        String name1 = intent.getStringExtra("TextBox1");
